...
${MODULE_TEST_TARGETS}: development-image data-loaded-image-1 ${DOCKER_BUILD_TARGETS} clean-network-environment
...
${UNIT_TEST_TARGETS}: development-image data-loaded-image-1 ${DOCKER_BUILD_TARGETS} clean-network-environment
