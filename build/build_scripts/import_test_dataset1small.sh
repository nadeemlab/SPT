...
spt cggnn upload-importances --study-name "Melanoma intralesional IL2" --database_config_file build/db/.spt_db.config.local --importances_csv_path test/test_data/gnn_importances/3.csv
