...
spt cggnn upload --study "Melanoma intralesional IL2" --spt_db_config_location build/db/.spt_db.config.local --importances_csv_path test/test_data/gnn_importances/3.csv
