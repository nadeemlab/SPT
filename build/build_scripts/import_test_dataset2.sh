...
nextflow run .
spt cggnn upload-importances --study-name "Breast cancer IMC" --database_config_file build/db/.spt_db.config.local --importances_csv_path test/test_data/gnn_importances/2.csv
