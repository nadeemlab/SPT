...
nextflow run .
spt cggnn upload --study "Breast cancer IMC" --spt_db_config_location build/db/.spt_db.config.local --importances_csv_path test/test_data/gnn_importances/2.csv
