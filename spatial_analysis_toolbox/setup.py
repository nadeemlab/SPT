...
setuptools.setup(
    ...
    python_requires='>=3.7',
    scripts=[
        'spatial_analysis_toolbox/bin/sat-pipeline',
        'spatial_analysis_toolbox/bin/sat-analyze-results',
        'spatial_analysis_toolbox/bin/sat_generate_jobs.py',
        'spatial_analysis_toolbox/bin/sat_diffusion_analysis.py',
        'spatial_analysis_toolbox/bin/sat_cell_phenotype_proximity_analysis.py',
        'spatial_analysis_toolbox/bin/sat_print.py',
    ],
