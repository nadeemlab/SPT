...
spt workflow configure --local --input-path=../test_data/adi_preprocssed_tables/dataset1/ --workflow='phenotype proximity' --database-config-file=../db/.spt_db.config.container
nextflow run .
