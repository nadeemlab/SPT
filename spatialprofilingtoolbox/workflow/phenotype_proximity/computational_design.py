...
"""
from spatialprofilingtoolbox.workflow.computational_visitor.computational_design\
    import ComputationalVisitorDesign


class PhenotypeProximityDesign(ComputationalVisitorDesign):
    """
    The design object.
    """

    def __init__(self, balanced: bool = False, use_intensities: bool = False, **kwargs):
        """
        :param balanced: Whether to use balanced or unbalanced treatment of phenotype pairs.
        :type balanced: bool
