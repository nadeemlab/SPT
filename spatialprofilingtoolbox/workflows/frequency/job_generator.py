...
'''
    ...
    def __init__(self,
        ...
        **kwargs,
        ...
        """
        super(FrequencyJobGenerator, self).__init__(**kwargs)
    ...
    def generate_all_jobs(self):
        ...
        for i, row in self.file_metadata.iterrows():
            if row['Data type'] == HALOCellMetadataDesign.get_cell_manifest_descriptor():
                ...
                all_memory_requirements.append(memory_in_gb)

        max_memory = max(all_memory_requirements)
        ...
        contents = FrequencyJobGenerator.cli_call_template
        cli_call = contents
